            ...
            <div class="card">
                <section class="section">
                    <div class="content">
                        ...
                        <p>Please be aware that there are inherent security risks in transmitting data, such as e-mails, via the Internet, because it is impossible to safeguard completely against unauthorized access by third parties. Nevertheless, we shall safeguard your data, subject to this limitation.<br>
                           In particular, personal information will be transmitted via the Internet only if it does not infringe upon third-party rights, unless the respective party has given its prior consent in view of such security risks. Accordingly, as the Web site provider, we shall not be held liable for any damages incurred as a consequence of such security risks or for any related acts of omission on our part.<br>
                        ...
                        <h4>Disclaimer for the use of Facebook social plugins:</h4>
                        <p>Our website uses social plugins (“plugins”) provided by the social network facebook.com, operated by Facebook Inc., 1601 S. California Avenue, Palo Alto, CA 94304, USA (“Facebook”). The plugins are identifiable by a Facebook logo (white letter f on blue background, the word like or a thumb up icon) or the notice “Facebook Social Plugin”. For a full list of all social Plugins please see
                            ...
                            <br>
                           When you visit a page of our website that contains a social plugin, your browser establishes a direct connection to Facebook servers. Facebook directly transfers the plugin content to your browser which embeds the latter into the website, enabling Facebook to receive information about your having accessed the respective page of our website. Thus we have no influence on the data gathered by the plugin and inform you according to our <a href="http://www.facebook.com/help/?faq=17512">state of knowledge</a>.
                        </p>
                        ...
                        <p>For the information on the purpose and scope of data collection and procession by Facebook, as well as your rights in this respect and settings options for protecting your privacy please visit Facebook's privacy policy:
                            <a href="http://www.facebook.com/policy.php">http://www.facebook.com/policy.php</a>
                        </p>
                        <p>If you are a Facebook member and do not want Facebook to connect the data concerning your visit to our website with your member data already stored by Facebook, please log off Facebook before entering our website and delete your cookies. Furthermore it is possible to block the data generation of Facebook Plug-ins by using browser add-ons such as 'Facebook Blocker' </p>
                        ...
                        <p><em>
                            <a href="https://www.google.com/analytics/learn/privacy.html">Disclaimer for Google Analytics</a>,
                            <a href="http://www.google.com/intl/en/policies/privacy/">Disclaimer for Google +1</a>,
                            <a href="http://twitter.com/privacy">Disclaimer for Twitter</a>
                        </em></p>

                        <h3>Information according to §5 of TMG (German Tele-Media Act):</h3>
                        <strong>Human Connection gGmbH</strong><br>
                        Bahnhofstr. 11<br>
                        ...
                        <ul>
                            <li>+49 151 43 80 42 22</li>
                            <li>
                                <a href="mailto:info@human-connection.org">info@human-connection.org</a>
                            </li>
                            <li>
                                <a href="www.human-connection.org">www.human-connection.org</a>
                            </li>
                        </ul>
                        <strong>USt-ID. according to §27a of the German Sales Tax Law:</strong><br>
                        DE 284651760<br><br>
                        ...
                        <ul>
                            <li><strong>GLS Bank</strong>
                                <ul>
                                    <li>
                                        <strong>IBAN:</strong> DE08 4306 0967 7024 1934 00 | <strong>BIC/SWIFT:</strong> GENODEM1GLS
                                    </li>
                                </ul>
                            </li>
                        </ul>
